var questions = [
  {question:"Hey there, what's your first name?"},
  {question:"Thanks! How about your last name?"},
...
;(function(){
  ...
  function done() {
    ...
    h1.appendChild(document.createTextNode('Well, nice to meet you ' + questions[0].value + ' '+ questions[1].value + '!'))
    setTimeout(function() {
